...
namespace IdentaZone.IdentaMaster.UserEdit
{
    ...
    public partial class Base : Window
    {
        ...
        public String SID;
        private String[] fingers = new String[14] { "LEFT THUMB", "LEFT INDEX", "LEFT MIDDLE", "LEFT RING", "LEFT LITTLE", "RIGHT THUMB", "RIGHT INDEX", "RIGHT MIDDLE", "RIGHT RING", "RIGHT LITTLE", "LEFT PALM", "RIGHT PALM", "LEFT EYE", "RIGHT EYE" };


        public PluginManager PluginManager;
        public List<string> appSet;
